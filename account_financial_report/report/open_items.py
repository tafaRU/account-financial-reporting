...
class OpenItemsReport(models.AbstractModel):
    ...
    def _get_data(
        ...
        accounts_data = self._get_accounts_data(open_items_move_lines_data.keys(), company_id)
        return (
            move_lines,
            partners_data,
            journals_data,
        ...
        for account_id in open_items_move_lines_data.keys():
            ...
            for partner_id in open_items_move_lines_data[account_id].keys():
                ...
                for move_line in move_lines_by_partner:
                    ...
                    total_amount[account_id]["residual_currency"] += move_line["amount_residual_currency"]
                total_amount[account_id][partner_id][
                    "foreign_currency_id"
                ] = foreign_currency_id
